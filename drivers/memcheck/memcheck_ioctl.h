...
#define memcheck_bit_shift(v, i) ((v) & (1 << (i)))
...
#define LOGGER_MEMCHECK_DETAIL_WRITE	_IO(__MEMCHECKIO, 10)
...
#define IDX_USER_ASHMEM			(IDX_USER_START + 4)
#define IDX_USER_GPU			(IDX_USER_START + 5)
#define IDX_USER_END			IDX_USER_GPU
...
#define IDX_KERN_ASHMEM			(IDX_KERN_START + 8)
#define IDX_KERN_GPU			(IDX_KERN_START + 9)
#define IDX_KERN_END			IDX_KERN_GPU
...
#define MTYPE_USER_ASHMEM		(1 << IDX_USER_ASHMEM)
...
#define MTYPE_KERN_ASHMEM		(1 << IDX_KERN_ASHMEM)
#define MTYPE_KERN_GPU			(1 << IDX_KERN_GPU)
...
#define MTYPE_KERNEL	(MTYPE_KERN_ION | MTYPE_KERN_SLUB |	\
			...
			MTYPE_KERN_ASHMEM | MTYPE_KERN_GPU)
#define MTYPE_USER	(MTYPE_USER_PSS | MTYPE_USER_VSS | MTYPE_USER_ION | \
			MTYPE_USER_ASHMEM | MTYPE_USER_GPU)
