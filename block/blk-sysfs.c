...
static struct queue_sysfs_entry queue_mas_async_fail_cnt_entry = {
	.attr = {.name = "async_submit_bio_fail", .mode = S_IRUGO },
	.show = mas_queue_async_fail_cnt_show,
};
...
static struct attribute *queue_attrs[] = {
	...
	&queue_mas_async_fail_cnt_entry.attr,
